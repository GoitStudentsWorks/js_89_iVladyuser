import{s as f,c as k,f as u,a as g}from"./header-23be469b.js";const r="favoriteCocktails",i=document.querySelector(".add-to-favorite-coctail-list"),h=JSON.parse(localStorage.getItem(r))??[],s=async(t,a)=>{const n=document.querySelector(".add-to-favorite-list");if(t.length===0)n.innerHTML=`
           <div class="container">
